...
ggplot(element_networks_info)+
  ...
  geom_smooth(method = lm) -> Mineral_Plot
  ggsave("Mineral_Plot.png", Mineral_Plot, width = 7, height = 5)
```
...
ggplot(element_networks_info)+
  ...
  theme_bw()+
  theme(text = element_text(size = 13))+
  geom_smooth(method = lm) -> Localities_Plot
  ggsave("Localities_Plot.png", Localities_Plot, width = 7, height = 5)
```
